...
void DLVer::pushLoad(string IDAlum, int calif1, int calif2, int calif3) {
	if (aHead == NULL) {
...
void DLVer::push_frontLoad(string ID, int calif1, int calif2, int calif3) {
	if (aHead == NULL) {
...
void DLVer::push_backLoad(string ID, int calif1, int calif2, int calif3) {
	if (aHead == NULL) {
		aHead = getNewNodeLoad(ID, calif1, calif2, calif3);
		aTail = aHead;
	}
...
PVNODE DLVer::getNewNodeLoad(string IDAlum, int calif1, int calif2, int calif3) {
	PVNODE lTemp = new VNODE;
	if (lTemp) {
		lTemp->ID = IDAlum;
...
void DLHor::push_backLoad(string pClass, string ClassID, string IDAlum, int calif1, int calif2, int calif3) {
	if (aHead == NULL) {
		aHead = getNewNode(pClass, ClassID);
		aTail = aHead;
		aTail->sVer = new DLVer();
